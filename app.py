...
def legal():
    ...
    <p><b>販売業者:</b> 佐久間稜<br><b>所在地:</b> 北海道札幌市北区北13条西8丁目 北海道大学大学院<br><b>価格:</b> $5.00<br><b>支払方法:</b> クレジットカード決済<br><b>引き渡し:</b> 決済完了後即時ダウンロード<br><b>返品規定:</b> デジタルコンテンツのため返品不可<br><b>連絡先:</b> ryo1ryo2-1103@outlook.jp</p>
    <a href="/" style="color:#39FF14;">BACK</a></body>"""

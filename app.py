...
def home():
    ...
    # ここから下のHTML/JSでは、波括弧を Pythonに邪魔されないよう {{ }} と二重にしています
    return f"""
    <!DOCTYPE html>
    <html lang="en">
    <head>
        ...
        <div id="page3" class="screen">
            <div class="card" style="text-align:center;">
                ...
                <div class="summary-box">
                    ...
                    <ul class="val-list">
                        <li>● <span>7-Day</span> Optimized Protocol</li>
                        <li>● <span>Porphyranase</span> Enzyme Insights</li>
                        <li>● <span>Gold Standard</span> Stack for DNA</li>
                    </ul>
                </div>
                <button onclick="toPayment()" style="width:100%; border:none; background:var(--neon); color:#000;">Unlock Blueprint ($5.00)</button>
            </div>
        </div>
        <footer><div class="disclaimer">ADVICE ONLY. NOT A MEDICAL DIAGNOSIS.</div></footer>
        <script>
...
@app.route('/about')
def about():
    return """<body style="background:#000;color:#fff;padding:80px;font-family:sans-serif;line-height:2.8;"><h1 style="color:#39FF14;">ABOUT US</h1><p>Curated by Ryoh Sakuma, Hokkaido University.</p><a href="/" style="color:#39FF14;">BACK</a></body>"""

...
# --- 1. ENHANCED PDF ENGINE (Optimized Layout & Design) ---
def create_report(score):
    ...
    p.drawString(50, height - 85, "Curated biological supplements for DNA repair and longevity architecture.")
...
def home():
    ...
    <head>
        ...
        <style>
            ...
            .tagline {{ color:#444; letter-spacing:10px; margin-top:20px; font-size:0.8rem; text-transform:uppercase; font-weight:300; }}
    ...
    <body>
        ...
        <div id="page2" class="screen">
            <div class="card">
                ...
                <div class="q-item" onclick="this.querySelector('input').click()"><input type="checkbox" class="j" onclick="event.stopPropagation()"> RICE (DAILY)</div>
                <div class="q-item" onclick="this.querySelector('input').click()"><input type="checkbox" class="j" onclick="event.stopPropagation()"> MISO SOUP (DAILY)</div>
                <div class="q-item" onclick="this.querySelector('input').click()"><input type="checkbox" class="j" onclick="event.stopPropagation()"> SEAWEED (DAILY)</div>
                <div class="q-item" onclick="this.querySelector('input').click()"><input type="checkbox" class="j" onclick="event.stopPropagation()"> PICKLES (DAILY)</div>
                <div class="q-item" onclick="this.querySelector('input').click()"><input type="checkbox" class="j" onclick="event.stopPropagation()"> GREEN & YELLOW VEG</div>
                <div class="q-item" onclick="this.querySelector('input').click()"><input type="checkbox" class="j" onclick="event.stopPropagation()"> FISH (DAILY)</div>
                <div class="q-item" onclick="this.querySelector('input').click()"><input type="checkbox" class="j" onclick="event.stopPropagation()"> GREEN TEA (DAILY)</div>
                <div class="section-label" style="margin-top:30px;">02b // INVERSE FACTOR</div>
                <div class="q-item" onclick="this.querySelector('input').click()"><input type="checkbox" class="j-inv" onclick="event.stopPropagation()"> LOW BEEF/PORK INTAKE</div>
...
def about():
    ...
    <h1 style="color:#39FF14;">ABOUT US</h1>
...
def legal():
    return """<body style="background:#000;color:#fff;padding:80px;font-family:sans-serif;line-height:2.8;">
    <h1 style="color:#39FF14;">COMMERCE DISCLOSURE</h1>
